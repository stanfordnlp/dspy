    ...
    def from_mcp_tool(
        ...
        *,
        ...
        Args:
            ...
            result_mode: ``"structured"`` (default in DSPy 3.4) returns MCP structured content
                exactly when present, with existing text conversion as fallback.
                ``"text"`` preserves DSPy's legacy text/non-text conversion.
