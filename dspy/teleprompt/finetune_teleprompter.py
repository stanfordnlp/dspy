...
def process_dataset_threaded(dataset: List[Any], program: Callable, metric: Optional[Callable] = None, max_workers: int = None) -> List[Dict[str, Any]]:
    data = []
    num_threads = max_workers if max_workers else min(80, len(dataset)) #TODO: Dont limit to 80, just a temp fix
