...
class Field:
    ...
    def __init__(self, *, prefix=None, desc=None, input, format=None, dtype=None):
...
class InputField(Field):
    def __init__(self, *, prefix=None, desc=None, format=None, dtype=None):
        super().__init__(prefix=prefix, desc=desc, input=True, format=format, dtype=dtype)

class OutputField(Field):
    def __init__(self, *, prefix=None, desc=None, format=None, dtype=None):
        super().__init__(prefix=prefix, desc=desc, input=False, format=format, dtype=dtype)
