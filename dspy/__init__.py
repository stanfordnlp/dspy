...
from dspy.adapters import Adapter, ChatAdapter, JSONAdapter, XMLAdapter, TwoStepAdapter, BAMLAdapter, Image, Audio, History, Type, Tool, ToolCalls, Code  # isort: skip
