...
_SIG_SPEC_BEGIN = "# __FLEX_SIGNATURE_BEGIN__"
_SIG_SPEC_END = "# __FLEX_SIGNATURE_END__"
_MODULE_BEGIN = "# __FLEX_MODULE_BEGIN__"
_MODULE_END = "# __FLEX_MODULE_END__"
...
_FILE_HEADER_DOCSTRING = '''"""Implementation of a dspy.Flex module -- managed automatically.
...
def render_persisted_file(
    *,
    ...
    ``signature_spec`` is the human-readable rendering of the Signature this module was flexed
...
def parse_persisted_file(text: str) -> PersistedFlex | None:
    """Extract the signature hash and the module-class source from a Flex file."""
    try:
    ...
    return PersistedFlex(signature_hash=signature_hash, module_src=module_raw.strip("\n"))
