...
try:
    ...
    sacrebleu = None
    print("The 'sacrebleu' package is not installed. You can install it using the command: pip install sacrebleu")
...
try:
    ...
    AutoModel = None
    AutoTokenizer = None
    print("The 'transformers' package is not installed. You can install it using the command: pip install transformers")
...
try:
    ...
    torch = None
    F = None
    print("The 'torch' package is not installed. You can install it using the command: pip install torch")
...
def calculate_spBLEU(pred_answer, reference_answer, tokenize="flores101"):
    ...
    bleu = sacrebleu.sentence_bleu(pred_answer,
                                   reference_list,
                                   tokenize=tokenize)
...
def validate_answer_with_spBLEU(example, pred, trace=None, threshold=50):
    ...
    if sacrebleu is None:
        raise ImportError("""sacrebleu is required to calculate spBLEU score.
...
def validate_answer_with_cosine_similarity(example, pred, trace=None,
                                           threshold=0.85,
                                           tokenizer=None,
                                           model=None):
    """
