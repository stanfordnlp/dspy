...
class ChainOfThoughtWithHint(Predict):
    def __init__(
        self, signature, rationale_type=None, activated=True, **config
    ):
    ...
    def forward(self, **kwargs):
        ...
        if self.activated is True or (
            self.activated is None
            and dsp.settings.lm.provder
            == "openai"  # TODO: clarify, why we need this check?
        ):
