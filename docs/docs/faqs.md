...
:::warning Important
`DSP_CACHEDIR` should still be responsible for old clients (including dspy.OpenAI, dspy.ColBERTv2, etc.) and `DSPY_CACHEDIR` should be responsible for the new dspy.LM client.
:::
