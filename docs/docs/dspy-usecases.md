...
| **[DDI](https://www.ddiworld.com/)** | Used DSPy to automate behavioral analysis for clients, improving recall from 43% to 98%. [Blog](https://www.databricks.com/customers/ddi) |
