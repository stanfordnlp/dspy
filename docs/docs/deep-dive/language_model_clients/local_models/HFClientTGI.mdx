...
Refer to the [Text Generation-Inference Server API](/docs/deep-dive/language_model_clients/local_models/HFClientTGI) for setting up the TGI server locally.
