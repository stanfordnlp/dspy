...
1. **[`dspy.Predict`](/docs/deep-dive/modules/Predict)**:

2. **[`dspy.ChainOfThought`](/docs/deep-dive/modules/ChainOfThought)**: 

3. **[`dspy.ProgramOfThought`](/docs/deep-dive/modules/program-of-thought)**:

4. **[`dspy.ReAct`](/docs/deep-dive/modules/ReAct)**:

5. **[`dspy.MultiChainComparison`](/docs/deep-dive/modules/MultiChainComparison)**:
...
We'll assume you are already at least a little familiar with [DSPy signatures](/docs/building-blocks/signatures), which are declarative specs for defining the behavior of any module we use in DSPy.
