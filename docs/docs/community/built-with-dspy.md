...
| **[Unleashing the Power of Open Source Large Language Models for Cybersecurity: Key Insights and Challenges](https://doi.org/10.1002/spy2.70223)** | Uses DSPy Framework to optimize prompt engineering workflows to boost the performance of small models (less than 8B), narrowing the performance gap with larger ones (greater than 44B), which broadens deployment possibilities |
