...
def test_load_program_without_api_key():
...
def test_lm_dump_state_excludes_api_key():
    """Test that LM.dump_state() directly excludes API key."""
    lm = dspy.LM(
        model="openai/gpt-4o-mini",
        api_key="sk-test-key",
        temperature=0.7,
