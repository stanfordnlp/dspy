...
class TestCouchbaseRMUnit:
    ...
    def test_initialization(self, couchbase_rm):
    ...
    def test_forward_global_index(self, couchbase_rm, mock_cluster):
        """Test forward method with global index using mocks"""
    ...
    def test_forward_scoped_index(self, mock_cluster, mock_embedder):
        """Test forward method with scoped index using mocks"""
    ...
    def test_kv_get_text_unit(self, mock_cluster, mock_openai_embeddings):
        """Test KV get operation using mocks"""
    ...
    def test_embedder_missing_api_key(self):
        """Test Embedder initialization with missing API key"""
