...
if is_module_installed("langfuse") and is_module_installed("langfuse.openai"):
    """
...
if is_module_installed("openai.error") and is_module_installed("openai.openai_object"):
    import openai.error
...
class GPT3(LM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        default_model_type = (
            "chat"
            if ("gpt-3.5" in model or "turbo" in model or "gpt-4" in model or "o1" in model)
